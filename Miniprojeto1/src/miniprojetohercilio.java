...
public class miniprojetohercilio {
        public static void main(String[] args) throws Exception {
                ...
                escolhas += System.lineSeparator()
                                + "2. Paladin: Mestre de luta à distância, domínio leve da artes mágicas.";
                ...
                if (fase1 == 1) {
                        System.out.println(
                                        "Mesmo sofrendo um pouco, você conseguiu vencer o Ghost! Pode seguir sua jornada.");
                } else if (fase1 == 2) {
                ...
                if (fase2 == 1) {
                        ...
                        if (escolha2 == 1) {
                                ...
                                chefao += System.lineSeparator()
                                                + "2. Esperar que ele ataque novamente para ficar mais exposto";
                                ...
                                if (escolhafinal == 1) {
                                        System.out.println(
                                                        "Sua habilidade acertou em cheio o Spectral. Parabéns, você concluiu a Dungeon"
                                                                        +
